...
class Client {
  ...
  Map<String, dynamic> toMap() {  // Converte o objeto Client para um Map (para o Firestore)
...
factory Client.fromMap(Map<String, dynamic> map, String documentId) { // Cria um objeto Client a partir de um Map (do Firestore)
